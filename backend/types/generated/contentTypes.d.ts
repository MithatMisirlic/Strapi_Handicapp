...
export interface ApiAccessibilityFeatureAccessibilityFeature
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nameOfTheFeature: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiAccessibilityNeedAccessibilityNeed
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nameOfTheNeed: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    eventType: Schema.Attribute.Enumeration<
      ['Concert', 'Public speach', 'Something more']
    > &
      Schema.Attribute.Required;
    langueges: Schema.Attribute.Enumeration<['English', 'German']>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    >;
    maxCapacity: Schema.Attribute.Integer & Schema.Attribute.Required;
    nameOfTheEvent: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    seatMaps: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    contactInfo: Schema.Attribute.Component<'my-components.address', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Description: Schema.Attribute.String &
    ...
    nameOfLocation: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    StatusOfTicket: Schema.Attribute.Enumeration<
